...
The manifest description + version are already fixed in code (v1.1.1). The text below
...
1. Build is ready: **`dist/nativize-extension-1.1.1.zip`** (manifest v1.1.1, cleaned description).
2. Go to the **Chrome Web Store Developer Dashboard** → your item.
3. **Package**: upload `dist/nativize-extension-1.1.1.zip` (new version 1.1.1).
