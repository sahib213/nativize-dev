 ...
 *   starter — one-time, all platforms + features, NO ongoing updates, 1 app
  ...
  var PLANS = [
    {
      ...
      watermark: true,
      // Lemon Squeezy variant id that maps to this plan (free has none).
      variantId: null,
      highlights: ["1 iOS app", "Download the native kit", "Cloud build (iOS)", "“Built with Nativize” badge"]
    },
    {
      id: "starter", name: "Starter", tagline: "Ship one app",
      price: "$29", priceNote: "one-time", billing: "one-time",
      apps: 1, platforms: ALL_PLATFORMS,
      push: true, social: true, storeUpload: true, updates: false,
      watermark: false,
      variantId: "",
      highlights: ["1 app, all platforms", "Push + social sign-in", "Store auto-upload", "No watermark", "No ongoing updates"]
    },
    {
      id: "pro", name: "Pro", tagline: "Keep shipping", popular: true,
      price: "$12", priceNote: "per month", billing: "monthly",
      apps: 3, platforms: ALL_PLATFORMS,
      push: true, social: true, storeUpload: true, updates: true,
      watermark: false,
      variantId: "",
      highlights: ["Up to 3 apps", "Everything in Starter", "Unlimited updates & rebuilds", "Priority cloud builds"]
    },
    {
      id: "max", name: "Max", tagline: "For agencies",
      price: "$29", priceNote: "per month", billing: "monthly",
