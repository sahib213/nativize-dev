  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  function mount(opts) {
    ...
    panel.innerHTML =
      ...
      '<div class="nz-body">' +
        ...
        '<div class="nz-auth">' +
          ...
          '<div class="nz-hint" id="nz-authHint">One click — verifies your Nativize plan and GitHub access.</div>' +
        '</div>' +
        // ---- Essentials ----
    ...
    $("nz-projectBtn").addEventListener("click", function () {
      ...
      if (!st.token) return setStatus("Sign in with GitHub first so your plan can be verified.", "err");
