...
(function (root, factory) {
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  .nz-panel {
    ...
    width: min(410px, calc(100vw - 28px)); max-height: 82vh; overflow: hidden; display: none;
    border-radius: 22px; color: #e8e8f0;
  ...
  .nz-body { padding: 18px 22px 22px; overflow-y: auto; max-height: calc(82vh - 82px); }

  .nz-field { margin-bottom: 15px; }
  .nz-field label { display: block; font-size: 11px; text-transform: uppercase; letter-spacing: .6px; color: #9aa0b4; margin-bottom: 6px; }
  ...
  .nz-field textarea {
    width: 100%; padding: 11px 12px; border-radius: 11px; font-size: 12px; resize: vertical; min-height: 64px;
    background: rgba(255,255,255,.05); border: 1px solid rgba(255,255,255,.12); color: #f2f2f7; outline: none;
  ...
  .nz-hint { font-size: 11px; line-height: 1.45; color: #72798f; margin-top: 5px; }
  .nz-sub { margin: 12px 0 0 0; padding: 14px; border-radius: 14px; background: rgba(255,255,255,.035); border: 1px solid rgba(255,255,255,.08); display: none; }
  ...
  .nz-toggle-row { display: flex; align-items: center; justify-content: space-between; gap: 16px; padding: 12px 0 6px; }
  .nz-toggle-row .nz-tlabel { font-size: 13.5px; line-height: 1.25; font-weight: 650; color: #f1eff8; }
  .nz-toggle-row .nz-tsub { font-size: 11.5px; line-height: 1.35; color: #8d94a8; margin-top: 4px; }
  ...
  .nz-actions { display: flex; gap: 10px; margin-top: 18px; }
  .nz-btn {
  ...
  .nz-status { margin: 12px 0 6px; font-size: 12px; min-height: 16px; }
  ...
  function mount(opts) {
    ...
    style.textContent = STYLE +
      ".nz-actions-stack{flex-direction:column;gap:7px}" +
      ".nz-btn-hero{width:100%;font-size:15px;padding:13px 16px;font-weight:700}" +
      ".nz-build-sub{text-align:left;margin-top:3px}" +
      ".nz-advanced{margin-top:12px;border:1px solid rgba(255,255,255,.09);border-radius:16px;" +
        "background:linear-gradient(180deg,rgba(255,255,255,.045),rgba(255,255,255,.022));overflow:hidden;" +
      ...
      ".nz-section-toggle{width:100%;display:flex;align-items:center;justify-content:space-between;gap:14px;" +
        "padding:14px 15px;text-align:left;color:#ece9f6;background:transparent}" +
      ".nz-section-copy{display:flex;flex-direction:column;gap:3px;min-width:0}" +
      ...
      ".nz-auth{margin-bottom:16px;text-align:center}" +
      ...
      ".nz-signed{font-size:13px;color:#6ee7b7;font-weight:600;padding:11px 12px;background:rgba(110,231,183,.08);border-radius:12px}" +
      ...
      ".nz-paid-lock{display:none;margin:10px 0 4px;padding:10px 12px;border-radius:11px;text-align:left;" +
